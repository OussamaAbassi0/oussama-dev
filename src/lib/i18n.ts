...
const t: Record<SiteLang, Translations> = {
  ...
  fr: {
    ...
    hero: {
      ...
      stat2:"automatisations n8n",
      stat3:"note Malt & Upwork",
  ...
  en: {
    ...
    hero: {
      ...
      stat2:"n8n automations",
      stat3:"rating Malt & Upwork",
  ...
  es: {
    ...
    hero: {
      ...
      stat2:"automatizaciones n8n",
      stat3:"nota Malt & Upwork",
  ...
  nl: {
    ...
    hero: {
      ...
      scroll:"SCROLL",
      stat1:"projecten geleverd",
      stat2:"n8n-automatiseringen",
      stat3:"score Malt & Upwork",
