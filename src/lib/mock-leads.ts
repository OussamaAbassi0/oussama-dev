...
export const MOCK_LEADS: Record<string, Lead[]> = {
  ...
  "Cabinets comptables Lyon": [
    ...
    },
    {
      ...
      rating: 4.2,
      score: 78,
      signal: "Processus de clôture encore manuel — opportunité forte d'automatisation comptable ⚠️",
  ...
  "Plombiers Marseille": [
    ...
    },
    {
      ...
      rating: 3.9,
      score: 68,
      signal: "Note < 4/5 avec 80+ avis — automatisation des réponses clients améliorerait la note ⚠️",
